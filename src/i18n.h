...
enum StrID : uint16_t {
  ...
  S_ABOUT_1, S_ABOUT_2,
  // BT sub-menu
  S_BT_CLEAR, S_BT_BACK, S_BT_DEVICES, S_BT_NO_DEVICE,
  S_COUNT
};
...
static const char* const _STR[LANG_COUNT][S_COUNT] = {
  [LANG_EN] = {
    ...
    // About body
    [S_ABOUT_1]  = "I watch your Claude sessions. I sleep when idle, wake when you work, and get anxious when approvals pile up. Press A to approve prompts directly.",
    [S_ABOUT_2]  = "18 species: Settings > ascii pet",
    // BT sub-menu
    [S_BT_CLEAR] = "clear bonds",
    [S_BT_BACK]  = "back",
    [S_BT_DEVICES] = "devices",
    [S_BT_NO_DEVICE] = "no device",
  },
  [LANG_ZH] = {
    // Menu
    ...
    [S_APPROVED] = "\xe5\xb7\xb2\xe6\x89\xb9\xe5\x87\x86",
    [S_DENIED]   = "\xe5\xb7\xb2\xe6\x8b\x92\xe7\xbb\x9d",
    [S_NAPPED]   = "\xe4\xbc\x91\xe6\x81\xaf",
    [S_TOKENS]   = "tokens",
    [S_TODAY]    = "\xe4\xbb\x8a\xe6\x97\xa5",
    // Claude info
    [S_SESSIONS] = "\xe4\xbc\x9a\xe8\xaf\x9d",
    [S_RUNNING]  = "\xe8\xbf\x90\xe8\xa1\x8c",
    [S_WAITING]  = "\xe7\xad\x89\xe5\xbe\x85",
    [S_LINK]     = "\xe8\xbf\x9e\xe6\x8e\xa5",
    [S_VIA]      = "\xe6\x96\xb9\xe5\xbc\x8f",
    [S_BLE]      = "ble",
    [S_LAST_MSG] = "\xe6\x9c\x80\xe8\xbf\x91",
    [S_STATE]    = "\xe7\x8a\xb6\xe6\x80\x81",
    // Device info
    [S_BATTERY]  = "\xe7\x94\xb5\xe6\xb1\xa0",
    [S_CURRENT]  = "\xe7\x94\xb5\xe6\xb5\x81",
    [S_SYSTEM]   = "\xe7\xb3\xbb\xe7\xbb\x9f",
    [S_OWNER]    = "\xe4\xb8\xbb\xe4\xba\xba",
    [S_UPTIME]   = "\xe6\x97\xb6\xe9\x95\xbf",
    [S_HEAP]     = "\xe5\x86\x85\xe5\xad\x98",
    [S_BRIGHT]   = "\xe4\xba\xae\xe5\xba\xa6",
    [S_BT]       = "\xe8\x93\x9d\xe7\x89\x99",
    // BLE states
    ...
    [S_50K_TOKENS]    = " 50K tokens =",
    [S_LEVEL_UP]      = " \xe5\x8d\x87\xe7\xba\xa7+\xe7\x89\xb9\xe6\x95\x88",
    [S_HOW_ENERGY]    = "\xe8\x83\xbd\xe9\x87\x8f",
    [S_FACE_DOWN]     = " \xe5\x80\x92\xe6\x94\xbe\xe8\xbf\x9b\xe5\x85\xa5\xe7\x9d\xa1\xe7\x9c\xa0",
    [S_REFILLS]       = " \xe7\x9d\xa1\xe9\x86\x92\xe6\x81\xa2\xe5\xa4\x8d\xe6\xbb\xa1",
    [S_IDLE_OFF]      = "30s\xe6\x97\xa0\xe6\x93\x8d\xe4\xbd\x9c=\xe7\x86\x84\xe5\xb1\x8f",
    ...
    [S_HOLD_A_MENU]   = "\xe9\x95\xbf\xe6\x8c\x89" "A:\xe8\x8f\x9c\xe5\x8d\x95",
    // Pairing
    ...
    [S_HW_BUDDY]      = " > Hardware Buddy",
    [S_AUTO_CONNECT]  = " \xe8\x87\xaa\xe5\x8a\xa8\xe9\x80\x9a\xe8\xbf\x87" "BLE\xe8\xbf\x9e\xe6\x8e\xa5",
    // Credits
    ...
    [S_HOLD_A]         = "\xe9\x95\xbf\xe6\x8c\x89" "A",
    [S_MENU]           = "\xe8\x8f\x9c\xe5\x8d\x95",
    [S_POWER]          = "\xe7\x94\xb5\xe6\xba\x90",
    [S_TAP_OFF_HOLD_PWR] = "\xe7\x82\xb9\xe5\x87\xbb=\xe7\x86\x84\xe5\xb1\x8f \xe9\x95\xbf\xe6\x8c\x89=\xe5\x85\xb3",
    // About body
    [S_ABOUT_1]  = "",
    [S_ABOUT_2]  = "\x31\x38\xe7\xa7\x8d\xe5\xae\xa0\xe7\x89\xa9\xef\xbc\x9a\xe8\xae\xbe\xe7\xbd\xae\x20\x3e\x20\xe5\xae\xa0\xe7\x89\xa9\xe5\x88\x87\xe6\x8d\xa2",
    // BT sub-menu
    [S_BT_CLEAR] = "\xe6\xb8\x85\xe9\x99\xa4\xe9\x85\x8d\xe5\xaf\xb9",
    [S_BT_BACK]  = "\xe8\xbf\x94\xe5\x9b\x9e",
    [S_BT_DEVICES] = "\xe5\xb7\xb2\xe9\x85\x8d\xe5\xaf\xb9\xe8\xae\xbe\xe5\xa4\x87",
    [S_BT_NO_DEVICE] = "\xe6\x97\xa0\xe8\xae\xbe\xe5\xa4\x87",
  }
};
